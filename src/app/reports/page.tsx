  ...
  return `<div class="page">
    ...
    <div class="rc-top-grid">
      <section class="rc-student-card">
        <div class="rc-photo-wrap">${s.photoUrl ? `<img src="${s.photoUrl}" class="rc-photo" alt="Student profile photo"/>` : `<div class="rc-photo-fallback">${String(s.name || 'S').trim().charAt(0).toUpperCase()}</div>`}</div>
