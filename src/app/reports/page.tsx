...
.page{width:210mm;height:297mm;padding:5.5mm 6.5mm 0;display:flex;flex-direction:column;gap:2mm;page-break-after:always;break-after:page;overflow:hidden;background:#fffdf8;position:relative}
...
.rc-header-left{text-align:center}.rc-logo{width:31mm;height:25mm;object-fit:contain;display:block;margin:0 auto 1mm}.rc-logo-fallback{width:31mm;height:25mm;display:grid;place-items:center;font-size:13.92px;font-weight:900;color:#0b5b49;margin:auto}.rc-brand-caption{font-size:8.28px;line-height:1.2;color:#0b5b49;letter-spacing:.06em}.rc-brand-caption span{font-size:6.72px;color:#5e6d67;letter-spacing:.02em}
.rc-header-center{text-align:center}.rc-acronym{font-size:35.64px;line-height:.9;letter-spacing:.28em;font-weight:700;color:#083f34}.rc-school-name{font-size:17.4px;line-height:1.02;font-weight:700;text-transform:uppercase;color:#0a4136;margin-top:1.4mm}.rc-address{font-size:8.4px;color:#52635d;margin-top:1.2mm;text-transform:uppercase}.rc-motto{font-size:10.08px;margin-top:1.4mm;color:#173f37;letter-spacing:.03em}
.rc-header-right{text-align:center}.rc-quote-ar{font-size:12.48px;line-height:1.35;font-weight:700;color:#0b5b49}.rc-quote-en{font-family:Georgia,serif;font-size:8.52px;line-height:1.25;margin-top:1mm;color:#243d38}.rc-quote-ref{font-size:8.16px;margin-top:.7mm;color:#80651e}
.rc-ribbon{width:132mm;min-height:18mm;align-self:center;background:#064a3c;color:white;border:1.4mm solid #d2a52e;outline:1px solid #5c4612;border-radius:4mm;text-align:center;padding:2.4mm 7mm 1.7mm;position:relative;z-index:3;box-shadow:0 1mm 0 rgba(0,0,0,.08)}.rc-ribbon:before,.rc-ribbon:after{content:"◆";position:absolute;top:4.6mm;color:#d2a52e;font-size:11.16px}.rc-ribbon:before{left:4mm}.rc-ribbon:after{right:4mm}.rc-ribbon-title{font-size:25.08px;line-height:1;font-weight:700;letter-spacing:.05em}.rc-ribbon-term{font-size:10.08px;letter-spacing:.09em;margin-top:1.2mm;color:#f5e7b6}
.rc-top-grid{display:grid;grid-template-columns:1fr 34mm 25mm;gap:1.5mm;min-height:30mm;align-items:stretch}.rc-student-card,.rc-status-card{border:1px solid #d1c493;border-radius:2.8mm;background:#fffefa}.rc-student-card{display:flex;overflow:hidden}.rc-photo-wrap{width:28mm;min-width:28mm;padding:2.5mm 0 2.5mm 2.5mm;display:flex;align-items:stretch}.rc-photo{width:25.5mm;height:25mm;object-fit:cover;display:block;border:1px solid #c9bea0;border-radius:2.2mm;background:#eef2ef}.rc-photo-fallback{display:grid;place-items:center;font-size:21.12px;font-weight:800;color:#0a4c3d;background:#edf4f0}.rc-student-main{flex:1;padding:2.5mm 4mm 1.8mm}.rc-label,.rc-detail-grid span,.rc-final-label{display:block;font-size:8.4px;color:#60716b}.rc-student-name{font-size:19.2px;font-weight:700;color:#092f29;line-height:1.05;margin:.8mm 0 2.1mm}.rc-detail-grid{display:grid;grid-template-columns:1.2fr 1.1fr .7fr .65fr;gap:0;border-top:1px solid #ded8c4}.rc-detail-grid div{padding:1.5mm 2mm 1mm 0;border-right:1px solid #ded8c4}.rc-detail-grid div:nth-child(4n){border-right:0}.rc-detail-grid div:nth-child(n+5){border-top:1px solid #ded8c4}.rc-detail-grid b{display:block;font-size:9.6px;line-height:1.15;margin-top:.4mm;color:#183b35}.rc-status-card{padding:3mm;text-align:center;display:flex;flex-direction:column;justify-content:center;min-width:0}.rc-att-title{font-size:10.08px;font-weight:700}.rc-att-value{font-size:19.8px;line-height:1.05;font-weight:700;color:#0a4c3d;margin:1mm 0;max-width:100%;white-space:normal;overflow-wrap:normal}.rc-status{background:#168447;color:white;border-radius:2mm;padding:1.4mm 2mm;font-size:10.44px;font-weight:700}.rc-qr-wrap{display:flex;flex-direction:column;align-items:center;justify-content:center}.rc-qr{width:21mm;height:21mm;image-rendering:auto}.rc-qr-label{font-family:Arial,sans-serif;font-size:8.28px;margin-top:1mm;color:#31423e;letter-spacing:.06em}
.rc-section{border:1px solid #cdbf8c;border-radius:2.6mm;overflow:hidden;background:#fffefa;flex-shrink:0}.rc-section-head{height:10mm;background:#07513f;color:white;display:flex;align-items:center;padding:0 4mm;font-size:16.56px;font-weight:700;letter-spacing:.035em}.rc-section-head em{margin-left:auto;font-size:9.6px;font-weight:400;font-style:italic;letter-spacing:.01em;color:#f3ecd5}.rc-section-icon{font-family:Arial,sans-serif;font-size:19.8px;margin-right:2.5mm;color:#f4e6ad}.rc-academic-body{display:grid;grid-template-columns:1fr 44mm;gap:2mm;padding:2mm 2.5mm 2.2mm}.rc-table{width:100%;border-collapse:collapse;font-family:Georgia,'Times New Roman',serif;font-size:9.48px}.rc-table th{background:#edf3ef;color:#163c35;font-size:8.04px;line-height:1.05;padding:1.8mm .8mm;border:1px solid #cbd5d0;text-align:center}.rc-table td{padding:2mm .8mm;border:1px solid #d2d9d5;text-align:center;height:8.3mm}.rc-table td:first-child{text-align:left;padding-left:1.5mm;white-space:nowrap}.rc-eval-no{display:inline-grid;place-items:center;width:4mm;height:4mm;border-radius:50%;background:#0b6b54;color:#fff;font-family:Arial,sans-serif;font-size:7.32px;margin-right:1.2mm}.rc-score,.rc-grade{font-weight:700;color:#064b3c}.rc-average{border:1px solid #b9c5bd;border-radius:2.2mm;background:linear-gradient(180deg,#f4f8f3,#fffefa);display:flex;flex-direction:column;align-items:center;justify-content:center;text-align:center;padding:2mm}.rc-average-title{font-family:Arial,sans-serif;font-size:9.84px;font-weight:700;letter-spacing:.08em;color:#345149}.rc-average-score{font-size:31.68px;line-height:1;font-weight:700;color:#075a47;margin:2mm 0 1mm}.rc-average-status{background:#198c4a;color:#fff;border-radius:2mm;padding:1.4mm 5mm;font-size:11.16px;font-weight:700}.rc-average-sub{font-size:8.88px;color:#4f625c;margin-top:1.4mm}
.rc-hifz{background:#fbfaf2}.rc-hifz .rc-section-head{height:10.5mm}.rc-hifz-main{display:grid;grid-template-columns:31mm 1fr 45mm;gap:3mm;align-items:center;padding:3mm 4mm 2.5mm;background:linear-gradient(90deg,#fbfcf8 0%,#fbfcf8 60%,#f2e7cc 100%)}.rc-ring-wrap{width:28mm;height:28mm;position:relative;margin:auto}.rc-ring{width:28mm;height:28mm;transform:rotate(0deg)}.ring-bg{fill:none;stroke:#d8e2dd;stroke-width:8}.ring-fill{fill:none;stroke:#13905c;stroke-width:8;stroke-linecap:round;transform:rotate(-90deg);transform-origin:50% 50%}.rc-ring-center{position:absolute;inset:0;display:flex;flex-direction:column;align-items:center;justify-content:center;text-align:center}.rc-ring-center b{font-size:17.16px;color:#083f34}.rc-ring-center span{font-size:8.16px;line-height:1.25;color:#33534b;text-transform:uppercase}.rc-small-cap{font-family:Arial,sans-serif;font-size:8.4px;letter-spacing:.12em;color:#987324;font-weight:700}.rc-position{font-size:19.8px;font-weight:700;color:#0a4438;margin:.7mm 0}.rc-hifz-sub,.rc-hifz-teacher{font-size:9.84px;color:#264a42}.rc-hifz-teacher{margin-top:.8mm}.rc-progress{height:3.8mm;background:#dce1df;border-radius:3mm;overflow:hidden;margin-top:2.4mm}.rc-progress span{display:block;height:100%;background:linear-gradient(90deg,#0d8051,#d0a12d);border-radius:3mm}.rc-progress-meta{display:flex;justify-content:space-between;font-size:8.4px;color:#596a64;margin-top:1mm}.rc-hifz-art{height:27mm;border-left:1px solid #d7c89f;display:flex;align-items:center;justify-content:center;gap:2mm;color:#7b6324;font-size:11.16px;font-style:italic;text-align:center}.rc-book-image{width:27mm;height:27mm;object-fit:contain;display:block;flex:0 0 auto}.rc-stats{display:grid;grid-template-columns:repeat(8,1fr);border-top:1px solid #cfc9b1;background:#fffefa}.rc-stats>div{min-height:17mm;padding:2mm 1mm;text-align:center;border-right:1px solid #d5d5c9;display:flex;flex-direction:column;justify-content:center;align-items:center}.rc-stats>div:last-child{border-right:0}.rc-stats span{font-family:Arial,sans-serif;font-size:8.04px;line-height:1.2;color:#35524a;text-transform:uppercase}.rc-stats b{font-size:19.8px;line-height:1;color:#0a6b50;margin-top:1.5mm}.rc-stats small{font-size:8.4px;color:#68736e}.rc-stats .remaining{background:#fffaf0}.rc-stats .remaining b{color:#1b3e57}.rc-stats .remaining:nth-child(5) b{color:#9a3737}.rc-stats .remaining:nth-child(7) b{color:#8d6b17}
.rc-final .rc-section-head{background:#f5ead0;color:#43552d;border-bottom:1px solid #d2b96e}.rc-final .rc-section-icon{color:#a27b1d}.rc-final-body{display:grid;grid-template-columns:1fr .75fr 1.5fr;align-items:center;min-height:22mm}.rc-final-col,.rc-final-score,.rc-final-details{padding:2mm 4mm}.rc-final-col{text-align:center;border-right:1px solid #d6d0bd}.rc-final-label{font-weight:700;color:#345047;font-size:9.6px;margin-bottom:1.5mm}.rc-final-badge{background:#137b3d;color:white;border-radius:2.5mm;padding:2mm 6mm;font-size:15.84px;font-weight:700}.rc-final-score{text-align:center;border-right:1px solid #d6d0bd}.rc-final-score b{display:block;font-size:34.32px;line-height:1;color:#0b5544}.rc-final-score span{font-size:10.08px;font-weight:700}.rc-final-details{font-family:Arial,sans-serif;font-size:8.88px;line-height:1.7;color:#203f38}
.rc-approval .rc-section-head{height:9mm}.rc-sign-grid{display:grid;grid-template-columns:repeat(3,1fr)}.rc-sign{min-height:24mm;padding:2.2mm 5mm 1.5mm;text-align:center;border-right:1px solid #d5d1c2;position:relative}.rc-sign:last-child{border-right:0}.rc-sign-name{font-size:11.16px;font-weight:700;color:#102f29;min-height:4mm}.rc-sign-role{font-family:Arial,sans-serif;font-size:8.64px;font-weight:700;letter-spacing:.06em;color:#35584f;margin-top:.4mm}.rc-sign-line{height:10mm;border-bottom:1px dotted #6f7a75;display:flex;align-items:flex-end;justify-content:center;margin-top:1mm}.rc-sign-img{max-width:42mm;max-height:10mm;object-fit:contain}.rc-sign-date{font-family:Arial,sans-serif;font-size:8.4px;color:#65716d;margin-top:1mm}
.rc-footer-band{margin-top:auto;height:9mm;background:#07513f;color:white;border-top:1.2mm solid #c99c2a;display:flex;align-items:center;justify-content:space-between;padding:0 10mm;font-size:9.12px;font-style:italic;position:relative;z-index:2}.rc-footer-band b{font-size:15.84px;font-style:normal;color:#f3e4a9}.rc-footer{height:5.5mm;display:flex;align-items:center;justify-content:center;font-family:Arial,sans-serif;font-size:8.4px;color:#3f4d49;white-space:nowrap}
