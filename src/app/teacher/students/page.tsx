...
export default function TeacherStudents() {
  ...
  async function saveEdit() {
    ...
    try {
      await teacherUpdateStudentQuranProfile(edit.id, { direction: edit.direction, currentSurah: Number(edit.current_surah), currentAyah: Number(edit.current_ayah) });
