 ...
 *{box-sizing:border-box;margin:0;padding:0}
 ...
 .contactBox{margin-top:8px;background:#eef4f0;border:1px solid #dbe6e1;border-radius:9px;padding:7px 9px}.contactBox .contactTitle{font-size:6px;font-weight:900;letter-spacing:1.4px;color:#8a6a1f;text-transform:uppercase;margin-bottom:4px}.contactLine{display:flex;justify-content:space-between;gap:8px;font-size:7.3px;line-height:1.45;color:#29483f}.contactLine b{font-weight:900;color:#07382f}.police{margin-top:5px;font-size:7.2px!important;font-weight:800;color:#4d5d57!important}
 ...
 <div class="card back">
  ...
  <div class="backBody"><div class="backKicker">Official School Identification Card</div><h2>This card belongs to ${esc(input.name)}</h2><p>This card is the property of Aliyu &amp; Maimuna Center for Qur’anic Memorization. It must be presented on request for school identity verification, attendance scanning, school access and approved academic services. It is not transferable.</p>
   ...
   <div class="contactBox"><div class="contactTitle">School emergency / verification contacts</div><div class="contactLine"><b>Director</b><span>${esc(contacts.directorPhone)}</span></div><div class="contactLine"><b>School Supervisor</b><span>${esc(contacts.supervisorPhone)}</span></div></div>
