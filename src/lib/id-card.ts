 ...
 *{box-sizing:border-box;margin:0;padding:0}
 ...
 .police{margin-top:4px;font-size:6.7px!important;font-weight:800;color:#4d5d57!important}.footerContact{position:absolute;right:9px;bottom:5px;text-align:right;font-size:5.2px;line-height:1.2;font-weight:800;color:#d5e3de;white-space:nowrap}.foot{position:relative;padding-right:105px!important}
 ...
 <div class="card back">
  ...
  </div><div class="foot">${esc(ENGLISH_SCHOOL_NAME)} · QR &amp; barcode encode the unique record for verification and attendance<div class="footerContact">Director: ${esc(contacts.directorPhone)}<br/>Supervisor: ${esc(contacts.supervisorPhone)}</div></div>
 </div>
 </div><script>
