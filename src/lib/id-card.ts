 ...
 *{box-sizing:border-box;margin:0;padding:0}
 ...
 .signRow{gap:2mm;margin-top:1.7mm}.directorSignImage{width:34mm;height:12mm;margin:0 auto .5mm;object-fit:contain;object-position:center bottom;display:block}.directorSignLabel{padding-top:.7mm;font-size:1.5mm;letter-spacing:.16mm}.directorSign small{font-size:1.15mm;letter-spacing:.1mm;margin-top:.25mm;font-weight:800}.signLine{margin-bottom:1.2mm}.terms{border-radius:1.5mm;padding:1.4mm 1.7mm}.terms b{font-size:1.25mm;letter-spacing:.25mm}.terms p{font-size:1.55mm;line-height:1.3;margin-top:.6mm}.police{margin-top:.8mm;font-size:1.65mm!important}.terms .police strong{font-weight:900;color:#07382f;letter-spacing:.05mm}
