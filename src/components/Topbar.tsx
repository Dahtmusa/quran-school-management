...
export default function Topbar({title}:{title:string}){
 ...
 {editProfile&&<div className="fixed inset-0 z-[100] flex items-end justify-center bg-slate-950/50 p-0 sm:items-center sm:p-5"><div className="max-h-[calc(100dvh-1rem)] w-full max-w-md overflow-y-auto overscroll-contain rounded-t-3xl bg-white p-5 pb-8 sm:max-h-[90vh] sm:rounded-3xl">
   ...
   {showSigForRole(me?.role)&&<div className="mt-6 scroll-mt-6 rounded-2xl border border-emerald-100 bg-emerald-50/40 p-4 sm:p-5">
