-- 066: Fix admin_get_student_directory to use new attendance_records schema
-- Migration 065 renamed the old attendance_records to attendance_records_legacy.
-- The RPC still referenced the old table name, causing it to fail and return no students.
