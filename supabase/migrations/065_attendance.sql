...
-- ─── Fix admin_get_student_directory RPC ────────────────────────────────────
-- The old RPC referenced attendance_records with old schema (student_id, status).
-- Rewrite it to use the new attendance_records table.
