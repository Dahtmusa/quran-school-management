          ...
          <section className="card p-4">
            <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
              <div>
                ...
                <div className="text-xs text-slate-500 mt-0.5">Fee allocations follow the student’s current section. Payments are locked to this term.</div>
              </div>
                    ...
                    <tr key={s.id} className="border-t hover:bg-slate-50/60 transition-colors">
                      ...
                      <td className="pr-3">
                        <div className="flex justify-end gap-1.5 flex-wrap">
                          ...
                          {currentTerm && <button onClick={() => printInvoice(s, currentTerm, structures, bank, currency, schoolName, logoUrl, schoolAddress)} className="btn bg-amber-50 text-amber-800 border border-amber-100 text-xs py-1.5 px-3">
                            Invoice
                          </button>}
                        </div>
                      </td>
